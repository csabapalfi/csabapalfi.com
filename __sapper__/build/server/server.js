...
var standard$1 = /*#__PURE__*/Object.freeze({
	'default': standard
});
...
var require$$0 = getCjsExportFromNamespace(standard$1);

var lite = new Mime_1(require$$0);
...
var sirv = function (dir, opts={}) {
	...
	if (opts.dev) {
		return function (req, res, next) {
			let uri = decodeURIComponent(req.path || req.pathname || url(req).pathname);
...
var require$$0$1 = getCjsExportFromNamespace(matchit);

const { exec: exec$1, match: match$1, parse: parse$1 } = require$$0$1;
...
const { parse: parse$2 } = querystring;
...
var require$$0$2 = getCjsExportFromNamespace(db$1);
...
const Slug = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<title>${escape(post.metadata.title)}</title>`, "")}
...
function embed_styles(content) {
  return `<style>${content}</style>`;
}

/* src/routes/_layout.svelte generated by Svelte v3.2.1 */
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { globalStyles } = $$props;

	if ($$props.globalStyles === void 0 && $$bindings.globalStyles && globalStyles !== void 0) $$bindings.globalStyles(globalStyles);
...
/* src/routes/_error.svelte generated by Svelte v3.2.1 */
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/([^\/]+?)\/?$/,
			parts: [
				{ name: "$slug", file: "[slug].svelte", component: Slug, preload: preload$1, params: match => ({ slug: d$1(match[1]) }) }
			]
		}
	],

	root: Layout,
	root_preload: preload$2,
	error: Error$1
};
...
function writable(value, start = noop$1) {
	...
	function subscribe(run, invalidate = noop$1) {
		...
		if (subscribers.length === 1) stop = start(set) || noop$1;
		run(value);
...
/* src/node_modules/@sapper/internal/App.svelte generated by Svelte v3.2.1 */
